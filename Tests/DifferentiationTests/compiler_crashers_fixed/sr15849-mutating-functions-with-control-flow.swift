...
public enum SR15849_Regression_Test {
...
protocol SR15849_Regression_Test_Layer: Differentiable {
...
extension SR15849_Regression_Test {
  struct BatchNorm<Scalar>: SR15849_Regression_Test_Layer { // Crash requires conformance to `Layer`
