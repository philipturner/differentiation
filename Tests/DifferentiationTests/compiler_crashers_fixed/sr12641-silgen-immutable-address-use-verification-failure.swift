...
public enum SR12641_Regression_Test {
  ...
  public static func f(_ c: Class) -> Resilient {
    return Resilient(x: 0)
  }
}

extension DifferentiationTests {
  func testSR12641() throws {
    _ = pullback(at: SR12641_Regression_Test.Class(
      SR12641_Regression_Test.Resilient(x: 10)), of: SR12641_Regression_Test.f)
  }
}
...
public extension SR12641_Regression_Test {
